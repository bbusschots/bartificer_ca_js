...
(function(bartificer, $, undefined){
    ...
    */
    ...
    bartificer.ca.Automaton.prototype.step = function(){
	    ...
	    this._generation++;
        //this.generationChange();
	    // trigger the generationChanged event and pass the current generation to the event handler as a paramater
	    $(this).trigger('generationChanged', [this._generation]);
