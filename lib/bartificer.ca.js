...
* @version 0.0.1
* @see {@link https://github.com/bbusschots/bartificer_ca_js}
*/
...
/**
 * The global namespace used by Bartificer Creations when publishing JavaScript
 * APIs.
 * @namespace
 */
...
(function(bartificer, $, undefined){
    ...
    /**
    * A JavaScript API for creating cellular automata within HTML documents.
    *
    * This API uses jQuery to interact with the DOM, so jQuery must be loaded
    * into the browser before loading this API.
    *
    * @namespace
    * @requires jQuery
