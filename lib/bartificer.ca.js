    ...
    bartificer.ca.Cell = class{
        ...
        constructor($td, x, y, s){
            ...
            if(typeof s !== 'undefined' && !isCellState(s)){
                throw new TypeError('if present, the fourth argument must be a bartificer.ca.State object');
            }
    ...
    bartificer.ca.Automaton = class{
        ...
        constructor($container, rows, cols, stepFn, renderFn, s){
            ...
            if(typeof s !== 'undefined' && !isAutomatonState(s, rows, cols)){
                throw new TypeError('if present, the sixth argument must be a bartificer.ca.State object, an array of state objects with the same dimensions as the automaton, or, a callback');
            }
